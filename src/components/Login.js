    ...
    <div>
      ...
      <div className="absolute">
        <img
          ...
          // className=" sm:h-screen object-cover md:h-screen object-cover lg:h-screen object-cover "
          className="h-screen object-cover lg:h-auto object-cover "
        />
      </div>
      <form
